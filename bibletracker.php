<?php
    ...
    // Include the JavaScript code for progress saving here

    // Display the HTML content of your Bible tracker page
?>
...
<head>
    ...
    <script src="bibletracker.js"></script>
...
<section id="home-section" class="">
        ...
        <div class="progress progressbig">
            <svg class="progress-circle" width="400px" height="400px" xmlns="http://www.w3.org/2000/svg">
                <circle class="progress-circle-back" cx="200" cy="200" r="180"></circle>
                <circle class="progress-circle-prog entirebibleprog" cx="200" cy="200" r="180"></circle>
            </svg>
            <div class="progress-text-p">of the entire bible</div>
            <div class="progress-text" id="entireBiblePercentageElement">0%</div>
        </div>
        ...
        <div class="testament-circles">
                ...
                <div class="progress progresshp" id="left-circle">
                    <svg class="progress-circle" width="250px" height="250px" xmlns="http://www.w3.org/2000/svg">
                        <circle class="progress-circle-back" cx="125" cy="125" r="120"></circle>
                        <circle class="progress-circle-prog oldtestamentprog1" cx="125" cy="125" r="120"></circle>
                    </svg>
               
           
        <div class="progress-text-p">old testament</div>
        <div class="progress-text" id="oldTestamentPercentageElement2">0%</div>
    </div>
    

    <div class="progress progresshp" id="right-circle">
        <svg class="progress-circle" width="250px" height="250px" xmlns="http://www.w3.org/2000/svg">
            <circle class="progress-circle-back" cx="125" cy="125" r="120"></circle>
            <circle class="progress-circle-prog newtestamentprog1" cx="125" cy="125" r="120"></circle>
        </svg>
       
        <div class="progress-text-p">new testament</div>
        <div class="progress-text" id="newTestamentPercentageElement2">0%</div>
    </div>
...
<section id="old-testament" class="the-old-testament">
    ...
    <div class="progress">
        <svg class="progress-circle" width="300px" height="300px" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle class="progress-circle-prog oldtestamentprog" cx="150" cy="150" r="140"></circle>
        </svg>
       
        <div class="progress-text-p">of the old testament</div>
        <div class="progress-text" id="oldTestamentPercentageElement1">0%</div>
    </div>
...
<section id="Exodus-Chapters" class="chapter-grid">
    ...
    <div class="progress">
        <svg class="progress-circle" width="300px" height="300px" xmlns="http://www.w3.org/2000/svg">
            <circle class="progress-circle-back" cx="150" cy="150" r="140"></circle>
            <circle class="progress-circle-prog exodusprog" cx="150" cy="150" r="140"></circle>
        </svg>
...
<section id="new-testament" class="the-new-testament">
    ...
    <div class="progress">
        <svg class="progress-circle" width="300px" height="300px" xmlns="http://www.w3.org/2000/svg">
            <circle class="progress-circle-back" cx="150" cy="150" r="140"></circle>
            <circle class="progress-circle-prog newtestamentprog" cx="150" cy="150" r="140"></circle>
        </svg>
